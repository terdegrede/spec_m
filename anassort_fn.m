function P = anassort_fn(M, N, A,B, mu, T, dS, dB)
% This function allows to compute -and save data from- the model
% considering anti-assortativity for controlled A (assortativity) and B 
% (similarity) lengths.
%
% Inputs:
%           M : Numer of genomes
...
%
% P = anassort_fn(M, N, B, mu, T, dS, dB);
